...
\tikzset{
  ...
  orx/.style={
    ...
    >={Stealth[length=5.5pt, width=4.4pt, inset=1.2pt]},
    line width=0.9pt,  % print-size stroke tier B: arrows, connectors, box outlines
  ...
  block/.style={
    draw=black!60, fill=white, rounded corners=1pt,
  ...
  ours/.style={block, draw=orxblue, fill=orxblue!7, line width=1.2pt},  % tier A
  % Context that must be present but is not the point.
  muted/.style={block, draw=black!40, fill=black!3, text=black!65, line width=0.8pt},
  ...
  % Reference guides (grid lines): stroke tier C, never below 0.6pt at print.
  guide/.style={draw=black!40, line width=0.6pt},
