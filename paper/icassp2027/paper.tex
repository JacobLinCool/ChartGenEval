...
\input{tables/baseline_numbers.tex}% post hoc Table 2 macros (auto-generated)
\hypersetup{pdftitle={ChartGenEval: Testing Rhythm-Game Chart Measurements with Controlled Errors},
pdfauthor={Jhen-Ke Lin, Chung Chun Wang},pdfkeywords={Music information retrieval, rhythm games, generation evaluation, timing}}
\title{ChartGenEval: Testing Rhythm-Game Chart\\Measurements with Controlled Errors}
\name{Jhen-Ke Lin, Chung Chun Wang}
\address{National Yang Ming Chiao Tung University\\
\texttt{jacob.cs14@nycu.edu.tw}, \texttt{takalawang.cs14@nycu.edu.tw}}
\begin{document}
\ninept
\maketitle
\suppressfloats[t]
...
sections, supported discussion, and, as instructed by the authors, wrote
experiment and visualization code. The authors verified all outputs and are
...
or donated computing resources supported this study. The authors declare
