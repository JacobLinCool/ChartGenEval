...
Rebuilds the full-train LM from taiko-1000-parsed-clean, scores the first N
official test charts with chartgeneval.evaluate_chart_quality using the bundled
calibration, and compares every shared numeric field against the released
clean-split official rows. Passes iff max abs diff < 1e-9.
